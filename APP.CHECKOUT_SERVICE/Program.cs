...
string queue_checkout_order = ConfigurationManager.AppSettings["queue_name"];
  string QUEUE_HOST = ConfigurationManager.AppSettings["QUEUE_HOST"];
 string QUEUE_V_HOST = ConfigurationManager.AppSettings["QUEUE_V_HOST"];
 string QUEUE_USERNAME = ConfigurationManager.AppSettings["QUEUE_USERNAME"];
 string QUEUE_PASSWORD = ConfigurationManager.AppSettings["QUEUE_PASSWORD"];
 string QUEUE_PORT = ConfigurationManager.AppSettings["QUEUE_PORT"];
 string QUEUE_KEY_API = ConfigurationManager.AppSettings["QUEUE_KEY_API"];
 string tele_token = ConfigurationManager.AppSettings["tele_token"];
 string tele_group_id = ConfigurationManager.AppSettings["tele_group_id"];
