...
namespace APP.CHECKOUT_SERVICE.Engines
{
    public class CheckOutFactory : ICheckOutFactory
    {
            ...
            IOrderTourBookingService tourBookingService)
        {
            ...
            _workQueueClient = new WorkQueueClient();
        }
        /// <summary>
                                ...
                                case 0:
                                    {
                                        ...
                                        if (order_id < 0) break;
                                        _workQueueClient.SyncES(order_id, "SP_GetOrder", "hulotoys_sp_getorder", 2);
                                        //1.2. Send mail (THANG)
                                ...
                                case 1:
                                    {
                                        ...
                                        if (updated_order == null) break;
                                        _workQueueClient.SyncES(order_info.order_id, "SP_GetOrder", "hulotoys_sp_getorder", 2);
